...
export default function EditTaskTagsModal(props) {
        ...
        <>
            ...
            <Modal show={show} onHide={handleClose}>
                <Modal.Header closeButton>
                    <Modal.Title>Change task tags</Modal.Title>
                </Modal.Header>
                <Form onSubmit={handleSubmit}>
                    <Modal.Body>
                        <Form.Control type="text" placeholder="Task tags"
                                      onChange={e => setValue(e.target.value)}
                                      className="mb-3" required={true} defaultValue={task.tags}/>
                        <span className="text-muted mt-3">Task tags are separated by space</span>
                    </Modal.Body>
                    <Modal.Footer>
